...
#folders+=(/projects/NS9034K/CMIP6/CMIP/NCC/NorCPM1/historical-ext)
#folders+=(/projects/NS9034K/CMIP6/DCPP/NCC/NorCPM1/dcppA-hindcast)
#folders+=(/projects/NS9034K/CMIP6/CMIP/NCC/NorCPM1/1pctCO2)
#folders+=(/projects/NS9034K/CMIP6/CMIP/NCC/NorCPM1/abrupt-4xCO2)
#folders+=(/projects/NS9034K/CMIP6/CMIP/NCC/NorCPM1/amip)
...
for (( i = 0; i < ${#folders[*]}; i++ )); do
    ...
    reals=($(find -maxdepth 1  -type d -name "$1*r*i${IREGEX}p1f1*" -print))
    #reals=($(find -maxdepth 1  -type d -name "*$1*" -print))
